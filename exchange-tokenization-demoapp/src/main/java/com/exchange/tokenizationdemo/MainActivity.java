package com.exchange.tokenizationdemo;
...
import com.exchange.api.tokenization.CardData;
import com.exchange.api.tokenization.InvalidParameterException;
import com.exchange.api.tokenization.Token;
import com.exchange.api.tokenization.TokenizationApiException;
import com.exchange.api.tokenization.TokenizationApi;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        api = TokenizationApi.builder()
                .gatewayHost(getString(R.string.exchange_gateway))
                .tokenizationHost(getString(R.string.exchange_tokenization))
                .integrationKey(getString(R.string.exchange_integrationkey))
                .build();
